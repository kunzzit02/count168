...
try {
    ...
    <head>
        ...
        <style>
            ...
            .count-badge { display: inline-block; padding: 4px 8px; border-radius: 12px; font-weight: bold; font-size: 12px; }
            .count-zero { background: #4CAF50; color: white; }
            .count-positive { background: #ff9800; color: white; }
            .count-critical { background: #f44336; color: white; }
