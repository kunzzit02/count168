...
<head>
    ...
    $fmLang = require __DIR__ . '/lang/' . $langCode . '.php';
    if (!is_array($fmLang)) { $fmLang = []; }
    ?>
    <title><?php echo htmlspecialchars(__('fm.title_page')); ?></title>
</head>
<body>
    <div class="container">
        <div class="maintenance-header">
            <h1 id="maintenance-page-title"><?php echo htmlspecialchars(__('fm.title_page')); ?></h1>
        ...
        <div class="maintenance-search-section formula-maintenance-filters-wrap">
            <div class="maintenance-filters">
                ...
                <div class="maintenance-form-group">
                    <label class="maintenance-label"><?php echo htmlspecialchars(__('fm.search')); ?></label>
                    <input type="text" id="search_filter" class="maintenance-input" placeholder="<?php echo htmlspecialchars(__('fm.search_formula_placeholder')); ?>">
                </div>
        ...
        <div class="maintenance-list-container" id="dataCaptureTableContainer" style="display: none;">
            ...
            <div class="maintenance-list-header">
                <div><?php echo htmlspecialchars(__('fm.no')); ?></div>
                <div><?php echo htmlspecialchars(__('fm.process')); ?></div>
                <div><?php echo htmlspecialchars(__('fm.account')); ?></div>
                <div><?php echo htmlspecialchars(__('fm.currency')); ?></div>
                <div><?php echo htmlspecialchars(__('fm.source')); ?></div>
                <div><?php echo htmlspecialchars(__('fm.product')); ?></div>
                <div><?php echo htmlspecialchars(__('fm.input_method')); ?></div>
                <div><?php echo htmlspecialchars(__('fm.formula')); ?></div>
                <div><?php echo htmlspecialchars(__('fm.description')); ?></div>
                <div class="maintenance-select-all-header" style="text-align: center;">
                    <input type="checkbox" id="select_all_data_capture" class="maintenance-checkbox" title="<?php echo htmlspecialchars(__('fm.select_all_title')); ?>" onchange="toggleSelectAllRows(this)">
                </div>
            </div>
    ...
    <script>
        ...
        window.__LANG = <?php echo json_encode($fmLang); ?>;
    </script>
