        ...
        function renderTable() {
            ...
            pageItems.forEach((account, idx) => {
                ...
                card.innerHTML = `
                    ...
                    <div class="account-card-item" style="display: flex; align-items: center; gap: 5px;">
                        ...
                        <input type="checkbox" class="account-row-checkbox" data-id="${account.id}" ${account.status === 'active' ? 'disabled title="Cannot delete active accounts"' : 'title="Select for deletion"'} onchange="updateDeleteButton()" style="margin-left: 5px;">
                    </div>
                `;
